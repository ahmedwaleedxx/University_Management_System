 ...
 * @author farouuk
 */
public class SuperiorAdminSalaryController {
     Registry r;
    SuperiorAdminSalary gui;
    FinanceInterface finance;
    EmployeeInterface employee;
    
     public SuperiorAdminSalaryController(FinanceInterface finance, SuperiorAdminSalary gui, Registry r) throws RemoteException{
        this.r = r;
        this.gui = gui;
        ...
        gui.getTestlbl().setText(employee.getEmployeeFName());
         ...
         try {
            ...
            gui.getSuperioradmin().setModel(model);
             EmployeeInterface emp;
            for (int i = 0; i < financee.getSuperiorAdmins().size(); i++) {
           ...
           gui.getUpdatesalarybtn().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                   try {
                    ...
                    admin.setSuperiorAdminSalary(id, salary);
