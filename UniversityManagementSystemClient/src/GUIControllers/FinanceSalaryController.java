...
public class FinanceSalaryController {
    ...
    EmployeeInterface employee;
     ...
     public FinanceSalaryController(FinanceInterface finance, FinanceSalary gui, Registry r) throws RemoteException{
        this.r = r;
        this.gui = gui;
        ...
        gui.getTestlbl().setText(employee.getEmployeeFName());
         ...
         try {
            ...
            gui.getFinance().setModel(model);
             EmployeeInterface emp;
            for (int i = 0; i < financee.getFinancier().size(); i++) {
                emp = (EmployeeInterface) financee.getFinancier().get(i);
           ...
           gui.getUpdatesalarybtn().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                   try {
                    ...
                    admin.setFinanceSalary(id, salary);
