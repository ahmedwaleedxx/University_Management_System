...
public class StudentFacade extends UnicastRemoteObject implements StudentFacadeInterface {
    ...
    public StudentFacade(Student student) throws RemoteException {
    ...
    public StudentDTO getStudnetDTO() throws RemoteException{
        StudentDTO s = new StudentDTO(student.getStudentID(),student.getStudentFName(),student.getStudentLName(),student.getEmail(),student.getPassword(), student.getStudentOverAllGrade(),student.isIsGraduated(),student.isPaidTutionFees(),student.getMajor(),student.getFaculty());
        return s;
